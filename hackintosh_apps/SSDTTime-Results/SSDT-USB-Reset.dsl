...
DefinitionBlock ("", "SSDT", 2, "CORP", "UsbReset", 0x00001000)
{
    ...
    External (\_SB.PCI0.GP19.XHC2.RHUB, DeviceObj)
    External (\_SB.PCI0.GPP7.UP00.DP60.XH00.RHUB, DeviceObj)
    External (\_SB.PCI0.GPP7.XH00, DeviceObj)
    ...
    Scope (\_SB.PCI0.GPP7.UP00.DP60.XH00.RHUB)
    {
        Method (_STA, 0, NotSerialized)  // _STA: Status
        {
            If (_OSI ("Darwin"))
